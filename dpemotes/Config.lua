...
Config.Languages = {
    ['tr'] = {
        ['emotes'] = 'Emoteler',
        ['danceemotes'] = "🕺 Dans Emoteları",
        ['propemotes'] = "📦 Eşya Emoteları",
        ['favoriteemotes'] = "🌟 Favoriler",
        ['favoriteinfo'] = "Favoriniz yapmak için buraya bir emote seçiniz.",
        ['rfavorite'] = "Favorileri resetle",
        ['prop2info'] = "❓ Prop emotelari en sonda görünür",
        ['set'] = "ayarla (",
        ['setboundemote'] = ") ayarlı emote'unuz olacak?",
        ['newsetemote'] = "~w~ artık ayarlı emote'unuz, kullanmak için ~g~CapsLock~w~ tuşuna basın.",
        ['cancelemote'] = "Emote Durdur",
        ['cancelemoteinfo'] = "~r~X~w~ Mevcut çalışan emote'u durdurur.",
        ['walkingstyles'] = "Yürüme Tarzları",
        ['resetdef'] = "Varsayılanı Yükle",
        ['normalreset'] = "Normal (Sıfırla)",
        ['moods'] = "Modlar",
        ['infoupdate'] = "Bilgi",
        ['infoupdateav'] = "Bilgi (Güncelleme mevcut)",
        ['infoupdateavtext'] = "Exile RP",
        ['suggestions'] = "Öneriler?",
        ['suggestionsinfo'] = "'Exile RP",
        ['notvaliddance'] = "geçerli bir dans değil.",
        ['notvalidemote'] = "geçerli bir emote değil.",
        ['nocancel'] = "İptal edecek emote yok.",
        ['maleonly'] = "Bu emote sadece erkeklerde çalışır!",
        ['emotemenucmd'] = "Menu için /emotemenu kullanın.",
        ['shareemotes'] = "👫 Karşılıklı Emotelar",
        ['shareemotesinfo'] = "Emote için birisini davet edin",
        ['sharedanceemotes'] = "🕺 Karşılıklı Danslar",
        ['notvalidsharedemote'] = "Geçerli bir karşılıklı dans değil.",
        ['sentrequestto'] = "Davet gönderilen kişi; ~y~",
        ['nobodyclose'] = "Etrafında ~r~yakın~w~ kimse yok.",
        ['doyouwanna'] = "~y~Y~w~ kabul, ~r~L~w~ red (~g~",
        ['refuseemote'] = "Emote reddedildi.",
        ['makenearby'] = "yakın kişinin oynamasını sağlar",
        ['camera'] = "Flaş için ~y~G~w~ tuşuna bas.",
        ['makeitrain'] = "Yağdırmak için ~y~G~w~ tuşuna bas.",
        ['pee'] = "İşemek için ~y~G~w~ tuşuna basılı tut.",
        ['spraychamp'] = "Şampanya için ~y~G~w~ tuşuna basılı tut",
        ['bound'] = "Bağlı ",
        ['to'] = "to",
        ['currentlyboundemotes'] = " Mevcut bağlı emotelar:",
